...
Sr. Field Engineering Manager - Pivotal +
jfullam@pivotal.io
...
NOTE: We will be updating the course materials throughout the class. You will need to have the materials cloned and track the `adp` branch.
