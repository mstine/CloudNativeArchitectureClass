...
. If you are on the Citi network, set the proxy as an environment variable:
+
----
...
+
----
$ cf api api.nyc.fe.pivotal.io --skip-ssl-validation
----

. Your username will be your employee ID. Password will be provided in the class.
. Follow the steps above for login.
. Create your own space and target that space:

----
$ cf create-space <your_username> -o <your_org>
$ cf target -s <your_username> -o <your_org>
----
Your org is displayed when you login, it should be either O1 or O2
